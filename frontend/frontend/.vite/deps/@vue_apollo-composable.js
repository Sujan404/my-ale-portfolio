                ...
                if (globalThis.__DEV__ !== false) {
                  var checkReference = function(ref2) {
                    if (_this.lookup(ref2.__ref) === void 0) {
                      globalThis.__DEV__ !== false && invariant2.warn(3, ref2);
                      return true;
                    }
                  };
...
function useQueryImpl(document, variables, options = {}, lazy = false) {
  ...
  currentInstance && ((_a2 = onServerPrefetch) == null ? void 0 : _a2(() => {
    var _a22;
  ...
  function getClient() {
    var _a22;
    return resolveClient((_a22 = currentOptions.value) == null ? void 0 : _a22.clientId);
  }
  ...
  function start() {
    ...
    if (started || !isEnabled.value || isServer && ((_a22 = currentOptions.value) == null ? void 0 : _a22.prefetch) === false || !currentDocument) {
      tryFirstResolve();
      return;
    }
    if (isServer) {
  ...
  function onNextResult(queryResult) {
    ...
    if (errorPolicy && errorPolicy === "all" && !queryResult.error && ((_a22 = queryResult.errors) == null ? void 0 : _a22.length)) {
  ...
  function processNextResult(queryResult) {
    var _a22, _b;
    result2.value = queryResult.data && Object.keys(queryResult.data).length === 0 ? queryResult.error && !((_a22 = currentOptions.value) == null ? void 0 : _a22.returnPartialData) && ((_b = currentOptions.value) == null ? void 0 : _b.errorPolicy) === "none" ? void 0 : result2.value : queryResult.data;
...
function useLazyQuery(document, variables, options) {
  ...
  function load(document2, variables2, options2) {
    ...
    if (isFirstRun) {
      ...
      return new Promise((resolve, reject) => {
        const { off: offResult } = query.onResult((result2) => {
          if (!result2.loading) {
