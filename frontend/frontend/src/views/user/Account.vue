<template>
    <div class="flex flex-col jusity-start items-center h-screen">
        ...
        <ul class="flex justify-center items-center my-4 font-sans font-medium">
            <div v-for="(tab, index) in tabs" :key="index">
                <li class="cursor-pointer py-2 px-4 text-gray-500 border-b-2"
                    :class="activeTab === index ? 'text-teal-700 border-teal-700' : ' '" @click="activeTab = index"
                    v-text="tab">
                </li>
            </div>
        </ul>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    v-model="signInDetails.usernam" />
                            </div>
                            <div>
                                <label for="email" class="block mb-1 text-grau-600 font-medium">Password</label>
                            </div>
                        </div>
                        <button
                            class="mt-4 w-full bg-teal-500 hover:bg-teal focus:ring focus:ring-teal-100 text-white py-2 rounded-md text-lg tracking-wide">
                            Sign In
                        </button>
                    </div>
                </form>
...
<script>
// import { mapActions, mapGetter } from "pinia";
