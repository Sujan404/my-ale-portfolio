<template>
  <div class="flex flex-col">
    <div>
      <img :src="this.backendServer + '/media/' + this.userInfo.avatar" alt=""
    ...
    <div class="grid grid-col-1 md:grid-cols-2 gap-4 my-2 border-2 p-10">
      ...
      <button
        ...
        type="button" @click="this.modalIsHidden = !this.modalIsHidden">
        Update Your Profile
      </button>
              ...
              <div class="p-6 space-y-6">
                <div class="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input v-model="profileUpdateInputs.firstName" name="firstName" type="text"
                  ...
                  <div>
                    ...
                    <input v-model="profileUpdateInputs.lastName" name="lastName" type="text"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-50" />
                  </div>
                </div>
                <div class="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <input v-model="this.userInfo.email" name="email" type="text" readonly
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-50"
                      value= />
                  </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input v-model="profileUpdateInputs.location" name="location" type="text"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-50" />
                  </div>
                  <div>
                    <label for="website" class="block mb-1 text-gray-600 font-medium">Website</label>
                    <input v-model="profileUpdateInputs.website" name="website" type="text"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-50" />
                  </div>
                </div>
                <div>
                  <label for="bio" class="block mb-1 text-gray-600 font-medium">Bio</label>
                  <textarea v-model="profileUpdateInputs.bio" type="text"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-50"
                    rows="5" />
                </div>
              </div>
    ...
    <div class="border-2 p-10 space-y-10 divide-y-2">
      ...
      <div v-for="comment in userInfo.commentSet" :key="comment.id" class="py-4">
        <h3 class="font-sans font-bold text-lg">
          ...
          <span v-if="comment.isApproved" class="text-teal-500">Approved</span><span v-else class="text-red-500"> Not
            Approved</span>
        </h3>
