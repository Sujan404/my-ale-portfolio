...
const RENDER_ARTICLES = ref([
  {
    title: BLOGS_INFO['dataStructuresAndAlgorithms']['title'],
    date: BLOGS_INFO['dataStructuresAndAlgorithms']['date'],
    readTime: BLOGS_INFO['dataStructuresAndAlgorithms']['readTime'],
    routeName: BLOGS_INFO['dataStructuresAndAlgorithms']['routeName'],
    summary: BLOGS_INFO['dataStructuresAndAlgorithms']['summary']
  },
  {
