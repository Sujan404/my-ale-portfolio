...
const RENDER_ARTICLES = ref([
  {
    title: BLOGS_INFO['wordPressVue']['title'],
    date: BLOGS_INFO['wordPressVue']['date'],
    readTime: BLOGS_INFO['wordPressVue']['readTime'],
    routeName: BLOGS_INFO['wordPressVue']['routeName'],
    summary: BLOGS_INFO['wordPressVue']['summary']
  },
  {
