<template>
    <Head>
      ...
      <meta name="og:description" content="How to integrate Vue.js with WordPress for dynamic front-end experiences" />
    ...
    <div class="max-w-screen-xl mx-auto p-4 sm:p-6 xl:p-8">
      <h1 class="text-3xl">{{ BLOGS_INFO['vueWordpressIntegration']['title'] }}</h1>
      <p id="read-text">
        {{ BLOGS_INFO['vueWordpressIntegration']['date'] }} |
        {{ BLOGS_INFO['vueWordpressIntegration']['readTime'] }} read
      </p>
  
      <!-- Introduction -->
      <section class="text-lg">
        <h2 class="my-3">
          WordPress powers over 40% of the web, while Vue.js has become one of the most popular JavaScript frameworks. 
          Combining WordPress's robust CMS capabilities with Vue's reactive frontend creates powerful, modern web applications.
        </h2>
        <h2 class="my-3">
          In this guide, we'll explore several practical approaches to integrate Vue with WordPress, from simple widgets to full headless architectures.
        </h2>
      </section>
      ...
      <section class="text-lg">
        <div>
          ...
          <ol class="my-3">
            <li>● <strong>Enhanced User Experience</strong>: Vue's reactivity creates smoother, more app-like interfaces</li>
            <li>● <strong>Progressive Enhancement</strong>: Add Vue components to specific parts of your site</li>
            <li>● <strong>Headless Possibilities</strong>: Use WordPress purely as a content backend</li>
            <li>● <strong>Developer Experience</strong>: Modern frontend development with a familiar CMS</li>
          </ol>
        </div>
      </section>
      ...
      <section class="text-lg">
        <div>
          ...
          <h2 class="my-3">
            The simplest way to add Vue to WordPress is by enqueuing Vue directly in a plugin or theme.
          </h2>
          
          <div class="my-3">
            <button @click="copyMethod1Plugin" class="relative ml-auto block">
              <span v-if="!copiedMethod1Plugin" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
  ...
  add_action('wp_enqueue_scripts', 'add_vue_to_wordpress');</pre>
          ...
          <h2 class="my-3">
            Then create a simple Vue app in <code>my-vue-app.js</code>:
          </h2>
  
          <div class="my-3">
            <button @click="copyMethod1JS" class="relative ml-auto block">
              <span v-if="!copiedMethod1JS" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    app.mount('#vue-app-container');
          ...
          <h2 class="my-3">
            Finally, add a container in your WordPress template:
          </h2>
  
          <div class="my-3">
            <button @click="copyMethod1HTML" class="relative ml-auto block">
              <span v-if="!copiedMethod1HTML" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  &lt;/div&gt;</pre>
      ...
      <section class="text-lg">
        <div>
          <h2 class="my-3 font-bold">Method 2: WordPress REST API with Vue SPA (Advanced Integration)</h2>
          <h2 class="my-3">
            For a more sophisticated approach, use WordPress as a headless CMS with a separate Vue single-page application.
          </h2>
          ...
          <div class="my-3">
            <button @click="copyMethod2Setup" class="relative ml-auto block">
              <span v-if="!copiedMethod2Setup" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  npm install vue-router</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod2Router" class="relative ml-auto block">
              <span v-if="!copiedMethod2Router" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  export default router</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod2Posts" class="relative ml-auto block">
              <span v-if="!copiedMethod2Posts" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  &lt;/script&gt;</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod2Single" class="relative ml-auto block">
              <span v-if="!copiedMethod2Single" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  &lt;/script&gt;</pre>
      ...
      <section class="text-lg">
        <div>
          ...
          <h2 class="my-3">
            For more complex data requirements, WPGraphQL provides a GraphQL API for WordPress, offering more efficient data fetching.
          </h2>
  
          <h3 class="my-2 font-bold">Step 1: Install WPGraphQL Plugin</h3>
          <p class="my-2">Install and activate the <a href="https://www.wpgraphql.com/" class="text-blue-600">WPGraphQL</a> plugin in WordPress.</p>
          ...
          <div class="my-3">
            <button @click="copyMethod3Setup" class="relative ml-auto block">
              <span v-if="!copiedMethod3Setup" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  npm install @vue/apollo-composable graphql @graphql-codegen/cli @graphql-codegen/typescript @graphql-codegen/typescript-operations @graphql-codegen/typescript-vue-apollo</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod3Apollo" class="relative ml-auto block">
              <span v-if="!copiedMethod3Apollo" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  app.mount('#app')</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod3Query" class="relative ml-auto block">
              <span v-if="!copiedMethod3Query" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  `</pre>
          ...
          <div class="my-3">
            <button @click="copyMethod3Component" class="relative ml-auto block">
              <span v-if="!copiedMethod3Component" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  &lt;/script&gt;</pre>
      ...
      <section class="text-lg">
        <div>
          ...
          <p class="my-2">Configure your server to proxy API requests to WordPress while serving the Vue app from the root.</p>
          
          <h3 class="my-2 font-bold mt-4">Option 2: Separate Domains (CORS Required)</h3>
          <p class="my-2">Deploy Vue app on a different domain/subdomain and configure CORS in WordPress:</p>
          <div class="my-3">
            <button @click="copyDeployCORS" class="relative ml-auto block">
              <span v-if="!copiedDeployCORS" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
  ...
  add_action('init', 'add_cors_http_header');</pre>
          ...
          <div class="my-3">
            <button @click="copyDeployNuxt" class="relative ml-auto block">
              <span v-if="!copiedDeployNuxt" class="copy-code-btn p-2 rounded-lg font-bold text-white">Copy Code</span>
              <span v-else class="copy-code-btn p-2 rounded-lg font-bold text-white">Copied!</span>
            </button>
          </div>
          <div class="bg-gray-100 overflow-auto">
    ...
    generate: {
      ...
      <section class="text-lg">
        <div>
          ...
          <ol class="my-3">
            <li>● <strong>Caching</strong>: Implement caching for API responses to reduce server load</li>
      ...
      <section class="text-lg">
        <div>
          ...
          <h2 class="my-3">
            Integrating Vue with WordPress offers the best of both worlds: WordPress's powerful content management with Vue's modern, reactive frontend capabilities. Whether you're adding small interactive components or building a complete headless CMS solution, these methods provide flexible options for every use case.
          </h2>
          <h2 class="my-3">
            For simple projects, the plugin approach works well. For more complex applications, consider the REST API or GraphQL methods. As your needs grow, you can progressively enhance your integration while maintaining WordPress as your content backbone.
          </h2>
        </div>
      </section>
    </div>
